...
export declare class ColumnListComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<ColumnListComponent, "kendo-grid-columnlist", never, { "autoSync": "autoSync"; "allowHideAll": "allowHideAll"; "actionsClass": "actionsClass"; "columns": "columns"; "applyText": "applyText"; "resetText": "resetText"; }, { "reset": "reset"; "apply": "apply"; "columnChange": "columnChange"; }, never, never>;
}
