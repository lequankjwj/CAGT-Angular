...
var AvatarComponent = /** @class */ (function () {
    ...
    AvatarComponent.propDecorators = {
        ...
        solidClass: [{ type: core_1.HostBinding, args: ['class.k-avatar-solid',] }],
        outlineClass: [{ type: core_1.HostBinding, args: ['class.k-avatar-outline',] }],
        borderClass: [{ type: core_1.HostBinding, args: ['class.k-avatar-bordered',] }],
        flexBasis: [{ type: core_1.HostBinding, args: ['style.flexBasis',] }],
