 ...
 */
export * from './main';
export { DIALOG_DIRECTIVES } from './dialog.module';
...
export { DIALOG_LOCALIZATION_SERVICE } from './localization/dialog-localization.service';
...
export { SHARED_DIRECTIVES, SharedModule } from './shared.module';
...
export { ResizeHandleDirective } from './window/window-resize-handle.directive';
