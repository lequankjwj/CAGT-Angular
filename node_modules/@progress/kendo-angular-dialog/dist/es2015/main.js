...
export { DialogCloseResult, DialogRef, DialogSettings, DialogAction } from './dialog/dialog-settings';
...
export { WindowSettings, WindowRef, WindowCloseResult } from './window/window-settings';
