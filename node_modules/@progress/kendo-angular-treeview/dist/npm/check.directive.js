...
var getDescendantsFromLookup = function (lookup) {
    if (!utils_1.isPresent(lookup) || lookup.children.length === 0) {
        return [];
    }
...
var ɵ2 = getDescendantsFromLookup;
exports.ɵ2 = ɵ2;
/**
...
var CheckDirective = /** @class */ (function () {
    ...
    CheckDirective.prototype.checkNode = function (node) {
        var _this = this;
        if (!utils_1.isPresent(node.item.dataItem) || this.treeView.isDisabledNode(node)) {
            return;
        }
        ...
        if (this.options.checkChildren) {
            var descendants = getDescendantsFromLookup(node)
                .filter(function (lookup) { return utils_1.isPresent(lookup.item.dataItem) && !_this.treeView.isDisabledNode(lookup); })
                .map(function (_a) {
                var item = _a.item;
    ...
    CheckDirective.prototype.addCheckedItemsChildren = function (lookups) {
        ...
        lookups.forEach(function (lookup) {
            ...
            lookup.children.forEach(function (item) {
                return utils_1.isPresent(item.dataItem) && checkedKeys.add(_this.itemKey(item));
            });
        });
