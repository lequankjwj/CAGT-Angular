...
var PagerComponent = /** @class */ (function () {
    ...
    PagerComponent.prototype.ngOnChanges = function (changes) {
        if (utils_1.anyChanged(["pageSize", "skip", "total", "allCount"], changes, false)) {
    ...
    PagerComponent.propDecorators = {
        ...
        treelistPagerClass: [{ type: core_1.HostBinding, args: ['class.k-grid-pager',] }],
