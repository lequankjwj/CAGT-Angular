 ...
 * @hidden
 */
exports.EXPANDED_STATE = {
    isExpanded: function () { return true; }
};
/**
 * @hidden
 */
exports.UNSELECTED_STATE = {
    isRowSelected: function () { return false; }
};
/**
 * @hidden
 */
exports.NOT_EDITED_STATE = {
...
exports.ViewItemFactory = ViewItemFactory;
/**
 * @hidden
 */
var ViewCollection = /** @class */ (function () {
    function ViewCollection(fieldAccessor, expandState, editState, selectionState) {
        ...
        this.resetPage = new core_1.EventEmitter();
        this.total = 0;
        this.totalVisible = 0;
        this.loaded = new Map();
        this.loading = false;
    ...
    ViewCollection.loadView = function (options) {
        ...
        var childrenView = new ViewCollection(viewFields, options.expandState || exports.EXPANDED_STATE, options.editState || exports.NOT_EDITED_STATE, options.selectionState || exports.UNSELECTED_STATE);
        if (options.loaded) {
    ...
    ViewCollection.prototype.loadData = function () {
        ...
        if (result.observables && result.observables.length) {
            ...
            if (!this.childrenSubscription) {
                this.childrenSubscription = new rxjs_1.Subscription();
            }
