...
var EditingDirectiveBase = /** @class */ (function () {
    ...
    EditingDirectiveBase.prototype.ngOnInit = function () {
        ...
        this.subscriptions.add(rxjs_1.merge(this.treelist.dataStateChange, this.treelist.pageChange).subscribe(this.onStateChange.bind(this)));
    };
    /**
     * @hidden
     */
