...
var cellAt = function (index, cells) {
    return elementAt(index, cells, function (cell) { return !dom_queries_1.hasClasses(cell, constants_1.NON_DATA_CELL_CLASSES) ? parseInt(cell.getAttribute('colSpan'), 10) || 1 : 0; });
};
var ɵ2 = cellAt;
exports.ɵ2 = ɵ2;
var EMPTY_OBJECT = {};
 ...
 * @hidden
 */
exports.SCROLLER_FACTORY_TOKEN = new core_1.InjectionToken('treelist-scroll-service-factory');
/**
 * @hidden
 */
...
var ListComponent = /** @class */ (function () {
    ...
    ListComponent.prototype.init = function () {
        ...
        this.rowHeightService = new row_height_service_1.RowHeightService(this.total, this.rowHeight);
    ...
    ListComponent.prototype.handleRowSync = function () {
        ...
        return rxjs_1.merge(this.changeNotification.changes, this.editService.changed, this.resizeService.changes, this.columnResizingService.changes
