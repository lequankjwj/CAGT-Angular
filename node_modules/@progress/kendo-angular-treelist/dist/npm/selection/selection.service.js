...
var selection_change_event_1 = require("./selection-change-event");
var kendo_angular_common_1 = require("@progress/kendo-angular-common");
/**
 * @hidden
 */
exports.defaultSelected = function (_item) { return false; };
...
var SelectionService = /** @class */ (function () {
    function SelectionService() {
        ...
        this.isSelected = exports.defaultSelected;
    ...
    SelectionService.prototype.init = function (treelist) {
        ...
        this.subscriptions.add(rxjs_1.merge(treelist.pageChange, treelist.dataStateChange).subscribe(function () {
    ...
    SelectionService.prototype.click = function (args, toggle) {
        ...
        if (originalEvent.keyCode === kendo_angular_common_1.Keys.Enter) {
            return;
        }
        ...
        if (this._settings.multiple) {
            if (originalEvent.shiftKey) {
                ...
                this.changes.next(new selection_change_event_1.SelectionChangeEvent(action, [{
                        dataItem: dataItem,
                        column: column,
                        columnIndex: columnIndex
                    }]));
    ...
    SelectionService.prototype.checkboxClick = function (args) {
        ...
        if (args.column.checkChildren && args.viewItem.hasChildren && !args.originalEvent.shiftKey && !args.originalEvent.ctrlKey) {
            ...
            data_collection_1.ViewCollection.loadView({
                ...
                _this.changes.next(new selection_change_event_1.SelectionChangeEvent(selected_1 ? 'remove' : 'add', selectedItems));
            });
        }
        else {
    ...
    SelectionService.prototype.toggleAll = function (select) {
        ...
        data_collection_1.ViewCollection.loadView({
            ...
            _this.changes.next(new selection_change_event_1.SelectionChangeEvent(select ? 'add' : 'remove', selectedItems));
        });
    };
    SelectionService.prototype.selectRange = function (firstPoint, secondPoint) {
        ...
        this.changes.next(new selection_change_event_1.SelectionChangeEvent('select', rangeItems));
    };
