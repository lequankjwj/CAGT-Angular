...
var EditDialogComponent = /** @class */ (function () {
    function EditDialogComponent(ngZone, editService, localization, changeDetector, element, focusService) {
        ...
        this.subs.add(rxjs_1.fromEvent(this.element.nativeElement, 'keydown')
            .pipe(operators_1.filter(function () { return _this.isActive; }))
            .subscribe(function (e) {
            if (e.keyCode === kendo_angular_common_1.Keys.Escape) {
                _this.reset();
            }
            if (e.keyCode === kendo_angular_common_1.Keys.Enter && (modifiers_1.withModifiers(e, modifiers_1.Modifiers.CtrlKey) || modifiers_1.withModifiers(e, modifiers_1.Modifiers.MetaKey))) {
                _this.onSave(e);
            }
            e.stopPropagation();
        }));
    ...
    Object.defineProperty(EditDialogComponent.prototype, "eventTimezone", {
        get: function () {
            return utils_1.formValueOrDefault(this.formGroup, this.fields.startTimezone, this.timezone);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(EditDialogComponent.prototype, "endTimezone", {
        get: function () {
            return utils_1.formValueOrDefault(this.formGroup, this.fields.endTimezone, this.eventTimezone);
        },
        enumerable: true,
        configurable: true
    });
    ...
    EditDialogComponent.prototype.readDateWithTimezone = function (field, timezone) {
        ...
        return kendo_date_math_1.ZonedDate.fromUTCDate(utils_1.toUTCDateTime(value), timezone).toLocalDate();
    };
