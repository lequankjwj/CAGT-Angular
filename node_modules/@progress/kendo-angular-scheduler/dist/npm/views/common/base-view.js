...
var BaseView = /** @class */ (function () {
    function BaseView(viewContext, viewState, intl, slotService, zone, renderer, element, pdfService, localization) {
        ...
        this.viewRangeChange = new rxjs_1.BehaviorSubject(null);
    ...
    BaseView.prototype.ngOnInit = function () {
        ...
        this.subs.add(rxjs_1.combineLatest(this.viewContext.items, this.viewState.dateRange, this.viewRangeChange)
    ...
    BaseView.prototype.bindEvents = function () {
        ...
        this.zone.runOutsideAngular(function () {
            ...
            _this.subs.add(rxjs_1.fromEvent(element, 'keydown')
    ...
    BaseView.prototype.dragHintClasses = function () {
        ...
        if (this.eventClass) {
            ...
            result = result.concat(utils_1.convertNgClassBindings(eventClass));
        }
        return result;
    };
    ...
    BaseView.prototype.emitSlotEvent = function (e, eventType) {
        var targetSlot = dom_queries_1.closestInScope(e.target, function (node) { return node.hasAttribute('data-slot-index'); }, this.element.nativeElement);
        if (targetSlot) {
    ...
    BaseView.prototype.containerByPosition = function (_a) {
        var x = _a.x, y = _a.y;
        var content = this.content.nativeElement;
        var offset = utils_1.elementOffset(content);
