...
var AgendaViewInternalComponent = /** @class */ (function () {
    ...
    AgendaViewInternalComponent.prototype.ngOnChanges = function (changes) {
        if (kendo_angular_common_1.anyChanged(['selectedDateFormat', 'selectedShortDateFormat', 'numberOfDays'], changes)) {
    ...
    AgendaViewInternalComponent.prototype.onAction = function (e) {
        ...
        if (e.type === 'next') {
            var next = kendo_date_math_1.getDate(kendo_date_math_1.addDays(now, this.numberOfDays));
    ...
    AgendaViewInternalComponent.prototype.dateRange = function (date) {
        ...
        var end = kendo_date_math_1.getDate(kendo_date_math_1.addDays(start, this.numberOfDays));
        var rangeEnd = kendo_date_math_1.getDate(kendo_date_math_1.addDays(start, this.numberOfDays - 1));
