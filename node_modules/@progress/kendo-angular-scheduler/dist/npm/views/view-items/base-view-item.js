...
var BaseViewItem = /** @class */ (function () {
    ...
    Object.defineProperty(BaseViewItem.prototype, "eventTitle", {
        get: function () {
            ...
            var time = utils_1.formatEventTime(startTime, endTime, this.item.isAllDay, this.localeId);
    ...
    BaseViewItem.prototype.ngOnChanges = function (changes) {
        ...
        if (kendo_angular_common_1.anyChanged(['index', 'resourceIndex', 'rangeIndex'], changes)) {
