...
import { Store, StoreConfig, filterNil, Query, setSkipAction, action } from '@datorama/akita';
...
RouterStore.ngInjectableDef = ɵɵdefineInjectable({ factory: function RouterStore_Factory() { return new RouterStore(); }, token: RouterStore, providedIn: "root" });
...
function slice(section) {
    return (source) => {
        return source.pipe(map((data) => data.state)).pipe(filterNil, map((state) => state[section]));
    };
}
...
RouterQuery.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: RouterQuery, factory: RouterQuery.ɵfac, providedIn: 'root' });
RouterQuery.ctorParameters = () => [
    { type: RouterStore }
];
RouterQuery.ngInjectableDef = ɵɵdefineInjectable({ factory: function RouterQuery_Factory() { return new RouterQuery(ɵɵinject(RouterStore)); }, token: RouterQuery, providedIn: "root" });
...
RouterService.ngInjectableDef = ɵɵdefineInjectable({ factory: function RouterService_Factory() { return new RouterService(ɵɵinject(RouterStore), ɵɵinject(RouterQuery), ɵɵinject(Router)); }, token: RouterService, providedIn: "root" });
__decorate([
...
let AkitaNgRouterStoreModule = class AkitaNgRouterStoreModule {
...
AkitaNgRouterStoreModule.ctorParameters = () => [
    { type: RouterService }
];
AkitaNgRouterStoreModule = __decorate([ __metadata("design:paramtypes", [RouterService])
