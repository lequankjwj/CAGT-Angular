...
var EntityStore = /** @class */ (function (_super) {
        ...
        this._setState(function (state) {
            return updateEntities({
                ...
                onEntityIdChanges: function (oldId, newId) {
                    ...
                    _this.entityIdChanges.next(tslib_1.__assign({}, entityIdChanged, { pending: true }));
                },
            });
        });
        if (entityIdChanged) {
            this.entityIdChanges.next(tslib_1.__assign({}, entityIdChanged, { pending: false }));
        }
    ...
    EntityStore.prototype.upsert = function (ids, newState, onCreate, options) {
        ...
        var newEntities = toArray.filter(predicate(false)).map(function (id) {
            ...
            var withId = tslib_1.__assign({}, entity, (_a = {}, _a[_this.idKey] = id, _a));
            if (isClassBased) {
    ...
    EntityStore.prototype.upsertMany = function (entities, options) {
        ...
        this._setState(function (state) { return (tslib_1.__assign({}, state, { ids: addedIds.length ? tslib_1.__spread(state.ids, addedIds) : state.ids, entities: tslib_1.__assign({}, state.entities, updatedEntities), loading: !!options.loading })); });
    ...
    EntityStore.prototype.replace = function (ids, newState) {
        ...
        this._setState(function (state) { return (tslib_1.__assign({}, state, { entities: tslib_1.__assign({}, state.entities, replaced) })); });
    };
    /**
     *
    ...
    EntityStore.prototype.move = function (from, to) {
        ...
        this._setState(function (state) { return (tslib_1.__assign({}, state, { 
            // Change the entities reference so that selectAll emit
            entities: tslib_1.__assign({}, state.entities), ids: ids })); });
    };
    ...
    EntityStore.prototype.addActive = function (ids) {
        ...
        this._setState(function (state) {
            ...
            var uniques = Array.from(new Set(tslib_1.__spread(state.active, toArray)));
    ...
    EntityStore.prototype.removeActive = function (ids) {
        ...
        this._setState(function (state) {
            return tslib_1.__assign({}, state, { active: Array.isArray(state.active) ? state.active.filter(function (currentId) { return toArray.indexOf(currentId) === -1; }) : null });
        });
    };
    /**
    ...
    tslib_1.__decorate([
        transaction(),
        tslib_1.__metadata("design:type", Function),
        tslib_1.__metadata("design:paramtypes", [typeof (_b = typeof T !== "undefined" && T) === "function" ? _b : Object]),
        tslib_1.__metadata("design:returntype", void 0)
