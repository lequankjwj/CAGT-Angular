...
var Store = /** @class */ (function () {
    ...
    Store.prototype.setLoading = function (loading) {
        ...
        if (loading !== this._value().loading) {
            ...
            this._setState(function (state) { return (tslib_1.__assign({}, state, { loading: loading })); });
        }
    };
    /**
     *
    ...
    Store.prototype.setError = function (error) {
        if (error !== this._value().error) {
            ...
            this._setState(function (state) { return (tslib_1.__assign({}, state, { error: error })); });
        }
    };
    // @internal
    ...
    Store.prototype.update = function (stateOrCallback) {
        ...
        var withHook = this.akitaPreUpdate(currentState, tslib_1.__assign({}, currentState, newState));
