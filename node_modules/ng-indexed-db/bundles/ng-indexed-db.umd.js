(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('rxjs/operators'), require('rxjs'), require('rxjs/internal/BehaviorSubject')) :
    typeof define === 'function' && define.amd ? define('ng-indexed-db', ['exports', '@angular/core', '@angular/common', 'rxjs/operators', 'rxjs', 'rxjs/internal/BehaviorSubject'], factory) :
    (global = global || self, factory(global['ng-indexed-db'] = {}, global.ng.core, global.ng.common, global.rxjs.operators, global.rxjs, global.rxjs['internal/BehaviorSubject']));
}(this, function (exports, core, common, operators, rxjs, BehaviorSubject) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NgDatabaseFactory = /** @class */ (function () {
        function NgDatabaseFactory() {
             ...
             */
            this.connectionsReady = new BehaviorSubject.BehaviorSubject(false);
            /**
        ...
        function (databases) {
             ...
             * @return {?}
             */
            function (response) { return _this.connections = response; })), operators.switchMap((/**
             * @param {?} response
             * @return {?}
             */
            function (response) { return rxjs.timer(100); })))
                .subscribe((/**
             * @return {?}
             */
        ...
        function (databases) {
            ...
            function (item) {
                ...
                operators$1.push(_this.createConnection(item.name, item.stores, 1));
            });
            ...
            return rxjs.forkJoin(operators$1)
                .pipe(operators.map(mappingResponse));
        };
        /**
     ...
     * @type {?}
     */
    var NG_DATABASES = new core.InjectionToken('NG_DATABASES');
    /**
    ...
    var IndexedDB = /** @class */ (function () {
        ...
        function (storeName, databaseName) {
            var _this = this;
            return this.onReady.pipe(operators.switchMap((/**
             * @return {?}
             */
        ...
        IndexedDB.ctorParameters = function () { return [
            { type: Array, decorators: [{ type: core.Inject, args: [NG_DATABASES,] }] },
            { type: IdGenerator },
    ...
    exports.NG_DATABASES = NG_DATABASES;
    exports.ɵb = IdGenerator;
    exports.ɵc = NgDatabaseFactory;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=ng-indexed-db.umd.js.map
